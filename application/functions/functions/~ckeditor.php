 ...
 *
 *  $data = array(
 *		// Id do textarea a ser substituída pelo CKEditor
 *		'id'	 => 'textarea',
 *		'path'	 => base_path('main') . 'plugins/ckeditor',
 *		'config' => array(
 *			'toolbar'					=> 'Full',
 *			'width'						=> 'auto',
 *			'height'					=> '800px',
 *			'filebrowserBrowseUrl' 		=> base_path('main') . 'plugins/ckeditor/ckfinder/ckfinder.html',
 *			'filebrowserImageBrowseUrl' => base_path('main') . 'plugins/ckeditor/ckfinder/ckfinder.html?Type=Images',
 *			'filebrowserFlashBrowseUrl' => base_path('main') . 'plugins/ckeditor/ckfinder/ckfinder.html?Type=Flash',
 *			'filebrowserUploadUrl' 		=> base_path('main') . 'plugins/ckeditor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Files',
 *			'filebrowserImageUploadUrl' => base_path('main') . 'plugins/ckeditor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Images',
 *			'filebrowserFlashUploadUrl' => base_path('main') . 'plugins/ckeditor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Flash'
 *	 	)
 *	);
 *
 *
