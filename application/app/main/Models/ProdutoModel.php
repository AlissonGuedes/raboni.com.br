...
namespace App\Models {
	...
	class ProdutoModel extends AppModel {
		...
		public function getAll($find = null) {
			...
			$this -> select('tb_produto.id, tb_produto.id_categoria, tb_produto.nome, tb_produto.descricao, tb_produto.modo_uso, tb_produto.imagem, tb_produto.status, tb_produto_categoria.categoria, tb_produto_categoria.slug');
			...
			$this -> where('tb_produto.status', '1');
			$this -> where('tb_produto_categoria.status', '1');
